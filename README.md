...
Сайт будет доступен по ссылке **https://ТВОЙ_НИК.github.io/bar-catch-of-day/** — можно открывать с телефона, ноут не нужен.

### Шаги

1. **Создай репозиторий на GitHub** с именем `bar-catch-of-day`.
...
2. **Подключи проект к репо** (если ещё не подключён):
   ...
   git commit -m "init"
   git branch -M main
   git remote add origin https://github.com/ТВОЙ_НИК/bar-catch-of-day.git
